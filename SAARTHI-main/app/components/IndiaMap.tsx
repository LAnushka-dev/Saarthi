  ...
  return (
    <>
      ...
      <aside className="absolute top-0 right-0 h-full w-80 bg-black/90 text-white p-5 border-l border-green-900 overflow-y-auto">
        ...
        {/* Saarthi + Pratik UI (integrated on landing) */}
        <div className="mb-6 pb-4 border-b border-gray-700">
          <div className="flex items-start gap-3">
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-green-600 to-blue-700 text-lg shadow-lg">
              🌾
            </div>
            <div className="min-w-0">
              <h1 className="text-lg font-bold leading-tight text-green-400">
                Saarthi
              </h1>
              <p className="mt-0.5 text-[11px] font-medium uppercase tracking-wide text-blue-300/90">
                Pratik UI
              </p>
              <p className="mt-1 text-[11px] leading-snug text-gray-400">
                Map, state insights, login, and ML models — one landing experience.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="pt-4 border-t border-gray-700">
          <h3 className="font-semibold mb-3 text-gray-300">ML Models</h3>
          <div className="space-y-2">
            {MODEL_CATALOG.map((model, index) => (
              ...
              >
                ...
                <div className="text-[11px] text-white/80">{model.description}</div>
              </button>
            ))}
          </div>
        </div>
